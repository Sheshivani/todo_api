# Generated by Django 3.1 on 2020-09-08 18:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reply', models.ManyToManyField(related_name='_comment_reply_+', to='app.Comment')),
            ],
        ),
        migrations.CreateModel(
            name='ToDoModel',
            fields=[
                ...
                ('participants', models.ManyToManyField(related_name='todo_participants', to=settings.AUTH_USER_MODEL)),
